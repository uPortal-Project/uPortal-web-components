 ...
 * @returns {Promise<Object>} Promise that resolves with the encoded and decoded token in an Object
 */
 ...
 * @returns {boolean} true for expired or invalid, false for active
 */
